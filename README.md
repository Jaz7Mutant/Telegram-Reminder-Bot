...
4.
  ...
  ## Артемий
  - [ ] Пофиксить проблему с потерей коннекта к базе данных
  - [ ] synchronized -> потокобезопасные структуры. Сохранить все сортировки и компараторы
  - [ ] Красивый вид дней месяца с указанием дней недели. (Спроси меня, я подробнее расскажу)
